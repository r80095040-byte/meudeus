  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft': '0 4px 20px -2px hsl(175 65% 35% / 0.15), 0 8px 40px -4px hsl(175 65% 35% / 0.1)',
        'coral': '0 4px 20px -2px hsl(18 85% 52% / 0.2), 0 8px 40px -4px hsl(18 85% 52% / 0.15)',
        'glow': '0 0 40px -10px hsl(175 65% 35% / 0.4)',
        'glow-coral': '0 0 40px -10px hsl(18 85% 52% / 0.4)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
